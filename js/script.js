...
//→→Functions←←
    ...
    function import_teachers_info(){
        ...
        return [
            ...
            <br>
            <h7 > Si la información es <u>correcta</u> haz click en <b>aceptar</b>, si necesitas <u>modificar</u> algo haz click en <strong>modificar</strong>?<h7>
            `,
            //Propieties
            icon: 'question',
                ...
                switch (value) {
                    ...
                    case 'Renuncias':
                        ...
                        Swal.fire({
                            ...
                            <ol>
                            <li>Enviar un mensaje al responsable de coordinación administrativa, enviando el ID y contacto de cada estudiante <a href="https://api.whatsapp.com/send?phone=544567891234&text= Coloque la siguiente informacion:                                                                                                                                                                         *-Nombre:*                                                                                                                                                                                                                   *-Numero de PA:*                                                                                                                                                                                                                    *-ID del alumno(si corresponde)*:                                                                                                                                                                                                                    *-Descripcion:*" target="_blank">haciendo click aquí</a>.</li>
                            <li>Completar el formulario de transferencias (colocando feedback de cada estudiante), para redirigirte <a href="formulario_espacio_vacio_a_modo_de_ejemplo" target="_blank"> haz click aquí</a>.</li>
                            <li>Completar el formulario de renuncia.</li>
                            <li>Enviar un mensaje al responsable del sector juridico</li>
                            <li>Enviar un mensaje al responsable de recursos humanos <a href="https://api.whatsapp.com/send?phone=544567891234&text= Coloque la siguiente informacion:                                                                                                                                                                         *-Nombre:*                                                                                                                                                                                                                   *-Numero de PA:*                                                                                                                                                                                                                    *-ID del alumno(si corresponde)*:                                                                                                                                                                                                                    *-Descripcion:*" target="_blank">haciendo click aquí</a>.</li>
                            </ol>
